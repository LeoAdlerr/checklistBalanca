...
<details>
  ...
  <table border="1" cellpadding="10" cellspacing="0" width="100%">
    ...
    <tbody>
      ...
      <tr><td valign="top">Gestão de Acesso</td><td valign="top"><strong>US-04</strong></td><td valign="top"><strong>Como um</strong> usuário registrado, <strong>eu quero</strong> fazer login, <strong>para que</strong> eu possa acessar o sistema de forma segura.</td><td valign="top" bgcolor="#fffde7">📅 <b>Planeado para Sprint 2</b></td></tr>
    </tbody>
  </table>
</details>
