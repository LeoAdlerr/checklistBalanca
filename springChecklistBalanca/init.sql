-- =======================================================
-- CRIA E SELECIONA O BANCO DE DADOS (LINHAS ADICIONADAS)
-- =======================================================
...
DROP TABLE IF EXISTS lookup_value_data; -- Também a nova tabela de lookup

-- DROP DAS ANTIGAS TABELAS DE TRADUÇÃO (SE AINDA EXISTIREM DE UMA VERSÃO ANTERIOR)
...
-- =======================================================
-- Inserção dos Pontos de Verificação padrão
-- =======================================================
